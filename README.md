...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/jinthagerman/dotfiles/master/install.sh`"
```
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/jinthagerman/dotfiles/master/install.sh`" -s ask
```
